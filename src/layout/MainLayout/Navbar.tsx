      ...
      <header className="sticky top-0 z-40 border-b bg-background/70 backdrop-blur-2xl shadow-sm">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
          ...
          <div className="flex items-center gap-6 lg:gap-12">
            {/* Hamburger  */}
            <button
              className="md:hidden flex items-center justify-center w-9 h-9 rounded-xl hover:bg-muted/40 transition-colors"
        ...
        >
          <div className="px-4 py-3 flex flex-col gap-3 bg-background/95 backdrop-blur-xl">
            {/* Mobile Search */}
            <div className="relative">
              ...
              <input
                ...
                className="h-10 w-full rounded-full border border-border bg-muted/30 pl-10 pr-4 text-sm outline-none focus:ring-2 focus:ring-primary/30 transition-all duration-200"
              />
            </div>
